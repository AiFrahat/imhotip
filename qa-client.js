...
addEventListener('DOMContentLoaded',async()=>{
  ...
  try{
    ...
    document.querySelector('#filters [data-category=all]').click();document.querySelector('#alphabet [data-letter=K]').click();check('A–Z filter',activeLetter()==='K'&&firstResult()==='kubernetes');
    ...
    search('encrypted connection');check('English definition search',firstResult()==='vpn');search('');
